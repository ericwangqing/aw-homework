class @BP.Detail-data-manager extends BP.Abstract-data-manager
  ...
  set-previous-and-next-ids: !-> # doc: 从list拿到列表的doc ids并更新pre 和 next
    ...
    @update-previous-and-next-ids is-show-links = (@doc-id and @doc-ids and not _.is-empty @doc-ids)


  update-previous-and-next-ids: (is-show-links)!-> # doc: 从list拿到列表的doc ids并更新pre 和 next
    if is-show-links
      pre = next = null
  ...
  get-doc-data: ({source, attr, option, value, query, multiple})-> # source 为当前doc的某个relation，或者当前doc
    ...
    @prepare-data-for-multi-ahead data-source, value, option